...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: './img/kang/run.png',
      framesMax: 4
    },
    jump: {
      imageSrc: './img/kang/jump.png',
      framesMax: 4
    },
    fall: {
      imageSrc: './img/kang/fall.png',
      framesMax: 4
    },
    attack1: {
      imageSrc: './img/kang/attack.png',
      framesMax: 4
    },
    takeHit: {
      imageSrc: './img/kang/takehit.png',
      framesMax: 4
    },
    death: {
      imageSrc: './img/kang/death.png',
      framesMax: 4
    }
  },
  attackBox: {
